...
class SearchExclude
{
    ...
    public function enqueueEditScripts()
    {
        wp_enqueue_script(
            ...
            plugin_dir_url( __FILE__ ) . 'js/search-excludes.js',
    ...
    {
        wp_register_style('search-exclude-stylesheet', plugins_url('/css/search-exclude-styles.css', __FILE__ ));
    ...
    {
        $columns['search_exclude'] = 'Search Excludes';
        return $columns;
    }
    ...
    public function addMetabox()
    {
        ...
        add_meta_box('sep_metabox_id', 'Search Excludes', array($this, 'metabox'), null, 'side');
    }
