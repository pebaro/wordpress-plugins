<table id="itpk-rt-denied-data" cellspacing="0" cellpadding="0">
	<thead>
		<tr>
	...
	<tbody>
		<?php
		$requestsQuery = $wpdb->get_results(
			"SELECT * FROM " . $wpdb->prefix . "presskit_requests WHERE kit_request='denied'"
		);

		foreach ( $requestsQuery as $result ) :
